      ...
      <ScrollAnimationWrapper>
        <div className="text-center mb-4 w-full p-8 md:p-24 bg-[#005ab0] text-white">
          ...
          <p className="mt-2 md:mt-4 text-sm md:text-md">
            Created on: {new Date(policy.created_at).toLocaleDateString()}{" "}
            Updated on: {new Date(policy.updated_at).toLocaleDateString()}
          </p>
        </div>
        ...
        <div className="px-4 md:px-8 lg:px-16 py-8">
          <div className="mb-8">
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                Providing you with this Notice of Privacy Practices and
                following its terms.
              </li>
              <li>
          ...
          <div>
            ...
            <p>
              ...
              any time. If the terms of the Notice are changed, the new terms
              will apply to all your health information, whether created or
              received by Mentia Health and Wellness LLC before or after the
              date on which the Notice is changed. Any material changes will be
              promptly posted in our office and on our website, if applicable.
            </p>
          </div>
        </div>
      </ScrollAnimationWrapper>
