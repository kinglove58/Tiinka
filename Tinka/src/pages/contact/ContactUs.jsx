...
function ContactUs() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-custom-image bg-cover bg-center h-64 flex items-center justify-center">
      ...
      >
        ...
        <div className="mb-4">
          <label className="block text-gray-700">
            On a scale of 1 to 10, how motivated are you to work on these goals?
          </label>
          <input
            type="number"
            name="motivation"
