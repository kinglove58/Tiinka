      ...
      <section className="bg-white py-16">
        <ScrollAnimationWrapper>
          <div className="mx-auto max-w-4xl space-y-6 px-5">
              ...
              <p className="text-lg leading-8 text-gray-700">Dr. Dosunmu provides comprehensive psychiatric evaluations, ongoing psychiatric follow-up, and individualized treatment planning for adolescents and adults experiencing a wide range of mental health concerns, including anxiety, depression, ADHD, bipolar disorder, mood disorders, trauma-related conditions, and other psychiatric concerns.</p>
