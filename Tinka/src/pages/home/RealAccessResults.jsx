...
const BarsGraphic = ({ active }) => (
  <div className="mx-auto flex h-36 w-full max-w-72 items-end justify-center gap-3 rounded-lg border border-white/80 bg-white/35 px-4 py-8">
...
const ResultCard = ({ stat, active, index }) => {
  ...
  return (
    <article
      className={`group flex min-w-0 min-h-[390px] flex-col justify-between rounded-lg ${stat.accent} px-6 py-7 text-center shadow-sm ring-1 ring-[#cfe3f6] transition duration-500 hover:-translate-y-1 hover:shadow-[0_24px_55px_-35px_rgba(0,90,176,0.55)] md:min-h-[430px] md:px-7 md:py-9 ${
    ...
    >
      ...
      <div>
        <div className="mb-3 flex items-center justify-center gap-2">
          ...
          <p className="text-sm font-bold uppercase text-[#005ab0]">
            {stat.title}
          </p>
        </div>
    ...
    >
      <div className="mx-auto max-w-7xl">
        <header className="mx-auto max-w-3xl text-center">
          <h2 id="real-access-results-heading" className="home-heading">
            Real access for{" "}
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-700">
            Start with the things that make care easier to begin: local
            coverage, insurance-friendly scheduling, and a clear first step.
          </p>
        </header>
...
NetworkGraphic.propTypes = { active: PropTypes.bool };
BarsGraphic.propTypes = { active: PropTypes.bool };
ProgressGraphic.propTypes = { active: PropTypes.bool };
StatGraphic.propTypes = { type: PropTypes.string, active: PropTypes.bool };
