                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-3 w-2/3">
                                        {service_data.map((service) => (
                                            <li className="w-full text-gray-800 hover:text-blue-800 transition duration-300">
                                                <Link to={`/services/${service.id}`} className='h-10 flex w-full'>{service.id}</Link>
                                            </li>
                                        ))}
                                    </div>
                                    <li className='w-full lg:w-2/4'>
                                        <img src={Teletherapy} alt="Teleterapy" className='h-auto' />
                                    </li>
                                </div>
                            }
                        </li>
                        <li className='w-full h-20 font-semibold text-gray-800 hover:text-blue-800 transition duration-300'><Link to={"/blogs"} className='h-10 lg:h-20 flex items-center'>Blogs</Link></li>
                        <li className='w-full h-20 font-semibold text-gray-800 hover:text-blue-800 transition duration-300'><Link to={"/"} className='h-10 lg:h-20 flex items-center'>FAQs</Link></li>
                        <li className='w-full h-20 font-semibold text-gray-800 hover:text-blue-800 transition duration-300'><Link to={"/policy"} className='h-10 lg:h-20 flex items-center'>Policy</Link></li>
                        <li className='w-full h-20 font-semibold text-gray-800 hover:text-blue-800 transition duration-300 text-nowrap'><Link to={"/contact"} className='h-10 lg:h-20 flex items-center'>Contact Us</Link></li>
                    </ul>
                </nav>
            </div>
        </header>
